...
class NewslettersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create newsletter" do
    assert_difference("Newsletter.count") do
      post newsletters_url, params: { newsletter: { body: @newsletter.body, slug: @newsletter.slug, title: @newsletter.title } }
    end
  ...
  test "should update newsletter" do
    patch newsletter_url(@newsletter), params: { newsletter: { body: @newsletter.body, slug: @newsletter.slug, title: @newsletter.title } }
